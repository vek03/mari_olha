...
public class frm_selected_film extends javax.swing.JFrame {
    ...
    private void data(){
        ...
        data_atual = date.format(dateTimeFormatter);
        data_devol = date.plusDays(15).format(dateTimeFormatter);
    }
    ...
    private void insert(){
            ...
            try {
                String insert_sql="insert into locacao  (`id_usuario`, `id_filme`, `usuario`, `filme`, `data_locacao`, `data_devolucao`, `form_pagamento`, `total`) values ('" + id_user + "','" + id_film + "','" + usuario + "','" + titulo.getText() + "','" + data_atual + "','" + data_devol + "','" + cboPagamento.getSelectedItem() + "','" + valor.getText() + "');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_selected_film.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String f = "";
                String g = "";
                new frm_selected_film(a, b, c, d, e, f, g).setVisible(true);
            }
        });
    }
