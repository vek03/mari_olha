...
public class frm_user_count extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_user_count.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String c = "";
                String d = "";
                new frm_user_count(a, b, c, d).setVisible(true);
            }
        });
    }
