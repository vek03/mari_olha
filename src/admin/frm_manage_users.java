...
public class frm_manage_users extends javax.swing.JFrame {
    ...
    private void update(){
        ...
        //inserindo o novo registro ao banco
        try {
            sql="update usuarios set nome='" + nome + "',endereco='" + endereco + "', telefone='" + telefone + "', dt_nasc='" + data_nasc + "' where id = " + txtCod.getText();
    ...
    public void mostrar_Dados(){
        try {
            ...
            txtNasc.setValue(con_cliente.resultset.getString("dt_nasc"));
