...
public class frm_manage_users extends javax.swing.JFrame {
    ...
    private void insert(){
        //adicionando os valores dos campos as variaveis
            ...
            try {
                String insert_sql="insert into usuarios  (`nome`, `dt_nasc`, `endereco`, `telefone`, `usuario`, `senha`) values ('" + nome + "','" + data_nasc + "','" + endereco + "','" + telefone + "','" + usuario + "','" + senha + "');";
    ...
    private void update(){
        ...
        try {
            if(txtCod.getText().equals("")){
                sql="insert into usuarios (nome, endereco, telefone, dt_nasc, usuario, senha) values ('" + nome + "','" + endereco + "','" + telefone + "','" + data_nasc + "','" + usuario + "','" + senha + "')";
                msg="Gravação de um novo registro";
            }else{
                //UPDATE
                sql="update usuarios set nome='" + nome + "',endereco='" + endereco + "', telefone='" + telefone + "', dt_nasc='" + data_nasc + "', usuario='" + usuario + "', senha='" + senha + "' where id = " + txtCod.getText();
        ...
        try {
            ...
            while(con_cliente.resultset.next()){
                modelo.addRow(new Object[]{
                    con_cliente.resultset.getString("id"),con_cliente.resultset.getString("nome"),con_cliente.resultset.getString("dt_nasc"),con_cliente.resultset.getString("telefone"), con_cliente.resultset.getString("endereco")
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String b = "";
                String c = "";
                new frm_manage_users(a, b, c).setVisible(true);
            }
        });
    }
