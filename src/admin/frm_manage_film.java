...
public class frm_manage_film extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTitle.setToolTipText("Insira o usuário do cliente");

        lblValor.setForeground(new java.awt.Color(255, 255, 255));
        lblValor.setText("Valor:");

        txtValor.setToolTipText("Insira o filme alugado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_manage_film.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String b = "";
                String c = "";
                new frm_manage_film(a, b, c).setVisible(true);
            }
        });
    }
