...
public class frm_login extends javax.swing.JFrame 
{
    ...
    public frm_login() 
    {
        ...
        lblCadastro.setText("<html><u>Cadastre-se aqui!</u></html>");
        logo();
        icone();
    }
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        if(radioAdmin.isSelected()){
            if(txtUser.getText().length() > 0 && txtSenha.getText().length() > 0){
                try{
                    String pesquisa = "select * from admin where usuario like '" + txtUser.getText() + "' && senha = " + txtSenha.getText() + "";
            ...
            if(txtUser.getText().length() > 0 && txtSenha.getText().length() > 0){
                try{
                    String pesquisa = "select * from usuarios where usuario like '" + txtUser.getText() + "' && senha = " + txtSenha.getText() + "";
                    con_cliente.executaSQL(pesquisa);
                    ...
                    if (con_cliente.resultset.first())
                    {
                        ...
                        String realUser = con_cliente.resultset.getString("usuario");
                        String realNome = con_cliente.resultset.getString("nome");
                        String realNasc = con_cliente.resultset.getString("dt_nasc");
